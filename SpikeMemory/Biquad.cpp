    ...
    int     cLim )
{
    ...
    //QG note: BK has a error-checking form of QObject::connect that he uses here.
    //It's good practice and we should emulate at a later point.
    //His method applies a STR2CHR to the signal and slot. Do we need this?

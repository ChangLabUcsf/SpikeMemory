...
//qg change: change ::close( x ) to close( x )
#define CLOSE( x )                  close( x )
#define IOCTL( x, y, z )            ::ioctl( x, y, z )
//qg change: include a prefix field for this macro
#define LASTERROR_STR( prefix )             std::strerror( errno )
#define LASTERROR_IS_CONNCLOSED()   \
